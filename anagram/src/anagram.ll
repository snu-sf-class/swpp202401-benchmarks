...
define dso_local i32 @count(i8 noundef zeroext %val, i64 noundef %len, ptr noundef %str) #0 {
entry:
  br label %for.cond
...
; Function Attrs: nounwind uwtable
define dso_local i32 @anagram(i64 noundef %len, ptr noundef %str1, ptr noundef %str2) #0 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  %call = call i32 @count(i8 noundef zeroext %val.0, i64 noundef %len, ptr noundef %str1)
  %call2 = call i32 @count(i8 noundef zeroext %val.0, i64 noundef %len, ptr noundef %str2)
...
if.end:                                           ; preds = %entry
  ...
  %mul = mul i64 %div, 8
  %mul1 = mul i64 %mul, 1
  %call2 = call noalias ptr @malloc(i64 noundef %mul1) #4
  %add3 = add i64 %call, 7
...
for.body18:                                       ; preds = %for.cond13
  ...
  %arrayidx23 = getelementptr inbounds i8, ptr %call7, i64 %idxprom22
...
for.end26:                                        ; preds = %for.cond.cleanup17
  %call27 = call i32 @anagram(i64 noundef %call, ptr noundef %call2, ptr noundef %call7)
