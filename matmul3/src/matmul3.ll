...
for.body6:                                        ; preds = %for.cond4
  ...
  %arrayidx14 = getelementptr inbounds i64, ptr %a, i64 %idxprom13
  ...
  %arrayidx20 = getelementptr inbounds i64, ptr %a, i64 %idxprom19
  ...
  %arrayidx26 = getelementptr inbounds i64, ptr %a, i64 %idxprom25
  %3 = load i64, ptr %arrayidx26, align 8
  %add27 = add i32 %i.0, 1
  %mul28 = mul i32 %add27, %dim
  %add29 = add i32 %mul28, %k.0
  %add30 = add i32 %add29, 0
  %idxprom31 = zext i32 %add30 to i64
  %arrayidx32 = getelementptr inbounds i64, ptr %a, i64 %idxprom31
  %4 = load i64, ptr %arrayidx32, align 8
  %add33 = add i32 %i.0, 1
  %mul34 = mul i32 %add33, %dim
  %add35 = add i32 %mul34, %k.0
  %add36 = add i32 %add35, 1
  %idxprom37 = zext i32 %add36 to i64
  %arrayidx38 = getelementptr inbounds i64, ptr %a, i64 %idxprom37
  ...
  %arrayidx44 = getelementptr inbounds i64, ptr %a, i64 %idxprom43
  %6 = load i64, ptr %arrayidx44, align 8
  %add45 = add i32 %i.0, 1
  %mul46 = mul i32 %add45, %dim
  %add47 = add i32 %mul46, %k.0
  %add48 = add i32 %add47, 3
  %idxprom49 = zext i32 %add48 to i64
  %arrayidx50 = getelementptr inbounds i64, ptr %a, i64 %idxprom49
  ...
  %arrayidx56 = getelementptr inbounds i64, ptr %a, i64 %idxprom55
  %8 = load i64, ptr %arrayidx56, align 8
  %add57 = add i32 %i.0, 2
  %mul58 = mul i32 %add57, %dim
  %add59 = add i32 %mul58, %k.0
  %add60 = add i32 %add59, 1
  %idxprom61 = zext i32 %add60 to i64
  %arrayidx62 = getelementptr inbounds i64, ptr %a, i64 %idxprom61
  %9 = load i64, ptr %arrayidx62, align 8
  %add63 = add i32 %i.0, 2
  %mul64 = mul i32 %add63, %dim
  %add65 = add i32 %mul64, %k.0
  %add66 = add i32 %add65, 2
  %idxprom67 = zext i32 %add66 to i64
  %arrayidx68 = getelementptr inbounds i64, ptr %a, i64 %idxprom67
  %10 = load i64, ptr %arrayidx68, align 8
  %add69 = add i32 %i.0, 2
  %mul70 = mul i32 %add69, %dim
  %add71 = add i32 %mul70, %k.0
  %add72 = add i32 %add71, 3
  %idxprom73 = zext i32 %add72 to i64
  %arrayidx74 = getelementptr inbounds i64, ptr %a, i64 %idxprom73
  %11 = load i64, ptr %arrayidx74, align 8
  %add75 = add i32 %i.0, 3
  %mul76 = mul i32 %add75, %dim
  %add77 = add i32 %mul76, %k.0
  %add78 = add i32 %add77, 0
  %idxprom79 = zext i32 %add78 to i64
  %arrayidx80 = getelementptr inbounds i64, ptr %a, i64 %idxprom79
  %12 = load i64, ptr %arrayidx80, align 8
  %add81 = add i32 %i.0, 3
  %mul82 = mul i32 %add81, %dim
  %add83 = add i32 %mul82, %k.0
  %add84 = add i32 %add83, 1
  %idxprom85 = zext i32 %add84 to i64
  %arrayidx86 = getelementptr inbounds i64, ptr %a, i64 %idxprom85
  ...
  %arrayidx92 = getelementptr inbounds i64, ptr %a, i64 %idxprom91
  %14 = load i64, ptr %arrayidx92, align 8
  %add93 = add i32 %i.0, 3
  %mul94 = mul i32 %add93, %dim
  %add95 = add i32 %mul94, %k.0
  %add96 = add i32 %add95, 3
  %idxprom97 = zext i32 %add96 to i64
  %arrayidx98 = getelementptr inbounds i64, ptr %a, i64 %idxprom97
  %15 = load i64, ptr %arrayidx98, align 8
  %add99 = add i32 %k.0, 0
  %mul100 = mul i32 %add99, %dim
  %add101 = add i32 %mul100, %j.0
  %add102 = add i32 %add101, 0
  %idxprom103 = zext i32 %add102 to i64
  %arrayidx104 = getelementptr inbounds i64, ptr %b, i64 %idxprom103
  %16 = load i64, ptr %arrayidx104, align 8
  ...
  %arrayidx110 = getelementptr inbounds i64, ptr %b, i64 %idxprom109
  %17 = load i64, ptr %arrayidx110, align 8
  ...
  %arrayidx116 = getelementptr inbounds i64, ptr %b, i64 %idxprom115
  %18 = load i64, ptr %arrayidx116, align 8
  ...
  %arrayidx122 = getelementptr inbounds i64, ptr %b, i64 %idxprom121
  %19 = load i64, ptr %arrayidx122, align 8
  ...
  %arrayidx128 = getelementptr inbounds i64, ptr %b, i64 %idxprom127
  %20 = load i64, ptr %arrayidx128, align 8
  ...
  %arrayidx134 = getelementptr inbounds i64, ptr %b, i64 %idxprom133
  %21 = load i64, ptr %arrayidx134, align 8
  ...
  %arrayidx140 = getelementptr inbounds i64, ptr %b, i64 %idxprom139
  %22 = load i64, ptr %arrayidx140, align 8
  ...
  %arrayidx146 = getelementptr inbounds i64, ptr %b, i64 %idxprom145
  %23 = load i64, ptr %arrayidx146, align 8
  ...
  %arrayidx152 = getelementptr inbounds i64, ptr %b, i64 %idxprom151
  %24 = load i64, ptr %arrayidx152, align 8
  ...
  %arrayidx158 = getelementptr inbounds i64, ptr %b, i64 %idxprom157
  %25 = load i64, ptr %arrayidx158, align 8
  ...
  %arrayidx164 = getelementptr inbounds i64, ptr %b, i64 %idxprom163
  %26 = load i64, ptr %arrayidx164, align 8
  ...
  %arrayidx170 = getelementptr inbounds i64, ptr %b, i64 %idxprom169
  %27 = load i64, ptr %arrayidx170, align 8
  ...
  %arrayidx176 = getelementptr inbounds i64, ptr %b, i64 %idxprom175
  %28 = load i64, ptr %arrayidx176, align 8
  ...
  %arrayidx182 = getelementptr inbounds i64, ptr %b, i64 %idxprom181
  %29 = load i64, ptr %arrayidx182, align 8
  ...
  %arrayidx188 = getelementptr inbounds i64, ptr %b, i64 %idxprom187
  %30 = load i64, ptr %arrayidx188, align 8
  ...
  %arrayidx194 = getelementptr inbounds i64, ptr %b, i64 %idxprom193
  %31 = load i64, ptr %arrayidx194, align 8
  %mul195 = mul i64 %0, %16
  %mul196 = mul i64 %1, %20
  ...
  %32 = load i64, ptr %arrayidx207, align 8
  %add208 = add i64 %32, %add201
  store i64 %add208, ptr %arrayidx207, align 8
  %mul209 = mul i64 %0, %17
  %mul210 = mul i64 %1, %21
  ...
  %arrayidx221 = getelementptr inbounds i64, ptr %c, i64 %idxprom220
  %33 = load i64, ptr %arrayidx221, align 8
  ...
  %arrayidx235 = getelementptr inbounds i64, ptr %c, i64 %idxprom234
  %34 = load i64, ptr %arrayidx235, align 8
  %add236 = add i64 %34, %add229
  store i64 %add236, ptr %arrayidx235, align 8
  %mul237 = mul i64 %0, %19
  %mul238 = mul i64 %1, %23
  ...
  %arrayidx249 = getelementptr inbounds i64, ptr %c, i64 %idxprom248
  %35 = load i64, ptr %arrayidx249, align 8
  %add250 = add i64 %35, %add243
  store i64 %add250, ptr %arrayidx249, align 8
  %mul251 = mul i64 %4, %16
  %mul252 = mul i64 %5, %20
  ...
  %36 = load i64, ptr %arrayidx263, align 8
  ...
  %arrayidx277 = getelementptr inbounds i64, ptr %c, i64 %idxprom276
  %37 = load i64, ptr %arrayidx277, align 8
  %add278 = add i64 %37, %add271
  store i64 %add278, ptr %arrayidx277, align 8
  %mul279 = mul i64 %4, %18
  %mul280 = mul i64 %5, %22
  ...
  %arrayidx291 = getelementptr inbounds i64, ptr %c, i64 %idxprom290
  %38 = load i64, ptr %arrayidx291, align 8
  ...
  %arrayidx305 = getelementptr inbounds i64, ptr %c, i64 %idxprom304
  %39 = load i64, ptr %arrayidx305, align 8
  %add306 = add i64 %39, %add299
  store i64 %add306, ptr %arrayidx305, align 8
  %mul307 = mul i64 %8, %16
  %mul308 = mul i64 %9, %20
  ...
  %40 = load i64, ptr %arrayidx319, align 8
  ...
  %arrayidx333 = getelementptr inbounds i64, ptr %c, i64 %idxprom332
  %41 = load i64, ptr %arrayidx333, align 8
  %add334 = add i64 %41, %add327
  store i64 %add334, ptr %arrayidx333, align 8
  %mul335 = mul i64 %8, %18
  %mul336 = mul i64 %9, %22
  ...
  %arrayidx347 = getelementptr inbounds i64, ptr %c, i64 %idxprom346
  %42 = load i64, ptr %arrayidx347, align 8
  %add348 = add i64 %42, %add341
  store i64 %add348, ptr %arrayidx347, align 8
  %mul349 = mul i64 %8, %19
  %mul350 = mul i64 %9, %23
  ...
  %arrayidx361 = getelementptr inbounds i64, ptr %c, i64 %idxprom360
  %43 = load i64, ptr %arrayidx361, align 8
  ...
  %44 = load i64, ptr %arrayidx375, align 8
  %add376 = add i64 %44, %add369
  store i64 %add376, ptr %arrayidx375, align 8
  ...
  %arrayidx389 = getelementptr inbounds i64, ptr %c, i64 %idxprom388
  %45 = load i64, ptr %arrayidx389, align 8
  %add390 = add i64 %45, %add383
  store i64 %add390, ptr %arrayidx389, align 8
  ...
  %arrayidx403 = getelementptr inbounds i64, ptr %c, i64 %idxprom402
  %46 = load i64, ptr %arrayidx403, align 8
  %add404 = add i64 %46, %add397
  store i64 %add404, ptr %arrayidx403, align 8
  ...
  %arrayidx417 = getelementptr inbounds i64, ptr %c, i64 %idxprom416
  %47 = load i64, ptr %arrayidx417, align 8
