...
; Function Attrs: nounwind uwtable
define dso_local i32 @jenkins_one_at_a_time_hash(i32 noundef %value, ptr noundef %key, i64 noundef %length) #0 {
entry:
  br label %while.cond
...
while.body:                                       ; preds = %while.cond
  %inc = add i64 %i.0, 1
  %arrayidx = getelementptr inbounds i8, ptr %key, i64 %i.0
...
if.end:                                           ; preds = %entry
  %call1 = call ptr @malloc_upto_8(i64 noundef %call)
  br label %for.cond
...
for.body11:                                       ; preds = %for.cond7
  %call12 = call i32 @jenkins_one_at_a_time_hash(i32 noundef %value.0, ptr noundef %call1, i64 noundef %call)
  br label %for.inc13
